...
| 27 | 每个自主决策（选方法/定参数/门降档/取经验） | SKILL.md | 铁律9 自决策留痕范围 | 0.8.0 |
| 28 | （依据=推测/无先例/争议未决） | references/05-decision.md | 低置信降级触发条件 | 0.8.0 |
| 29 | 永不自动执行 | references/05-decision.md | 五类红线不可自决 | 0.8.0 |
